...
# Define the username (Twitch channel name)
username = "xboxviewtv"
...
try:
    ...
    # Drop the existing "socio" database if it exists
    cursor.execute("DROP DATABASE IF EXISTS socio")

    # Create a new "socio" database
    cursor.execute("CREATE DATABASE socio")

    # Switch to the "socio" database
    conn.database = "socio"
...
if CHANNEL_ID:
    ...
    video_list = get_video_list(youtube, upload_id, "all_videos")
